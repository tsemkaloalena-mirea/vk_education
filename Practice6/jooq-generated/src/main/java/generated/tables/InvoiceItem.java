...
public class InvoiceItem extends TableImpl<InvoiceItemRecord> {
     ...
     */
    public final TableField<InvoiceItemRecord, Long> PRODUCT_ID = createField(DSL.name("product_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<InvoiceItemRecord, Long> INVOICE_ID = createField(DSL.name("invoice_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
