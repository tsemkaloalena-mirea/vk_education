...
public class Invoice extends TableImpl<InvoiceRecord> {
     ...
     */
    public final TableField<InvoiceRecord, Long> ORGANISATION_TIN = createField(DSL.name("organisation_tin"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
